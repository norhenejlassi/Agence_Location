...
public class UpdateData extends AppCompatActivity {
    ...
    Button btnUpdatefourni;
    String Uid,namep,phonep,emailp,passp,typep;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnUpdatefourni = findViewById(R.id.btnUpdatefourni);
       ...
       emailp=intent.getStringExtra("email");
        ...
        btnUpdatefourni.setOnClickListener(new View.OnClickListener() {
            @Override
