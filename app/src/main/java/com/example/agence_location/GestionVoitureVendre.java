...
public class GestionVoitureVendre extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnRetreive.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(GestionVoitureVendre.this, RetreiveDataCar.class);
                startActivity(i);
                finish();
            }
        });
    ...
    private void addCar(){
        ...
        if(!(etMatricule.getText().toString().isEmpty()&&etStyle.getText().toString().isEmpty()&&etMarque.getText().toString().isEmpty()&&etCarburant.getText().toString().isEmpty()&&etModel.getText().toString().isEmpty()&&etColor.getText().toString().isEmpty()&&etPrix.getText().toString().isEmpty())){
            ...
            VoitureVedue voiture = new VoitureVedue(id, etMatricule.getText().toString(), etStyle.getText().toString(), etMarque.getText().toString(), etCarburant.getText().toString(), etModel.getText().toString(), etColor.getText().toString(),etPrix.getText().toString());
